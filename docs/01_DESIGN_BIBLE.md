# Design Bible — A Mansão de Vesper

## 1. Visão do produto

**A Mansão de Vesper** é uma visual novel investigativa com exploração por menus, enigmas, documentos, NPCs e desafios de programação chamados **rituais**.

O jogador assume o papel de um investigador capaz de interpretar padrões sobrenaturais através de regras formais. No mundo do jogo, essa prática é tratada como ritualística; fora do jogo, o aluno escreve e executa código Java.
